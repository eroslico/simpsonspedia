...
const features = [
  ...
  {
    title: "Compare",
    description: "Compare your favorite characters side by side",
    emoji: "⚖️",
    path: "/compare",
    color: "from-purple-400 to-pink-500",
    stats: { value: 2, suffix: " chars" },
  },
  {
    title: "Predictions",
    description: "See fan predictions for upcoming episodes",
    emoji: "🔮",
    path: "/predictions",
  ...
  {
    title: "Statistics",
    description: "Dive into detailed stats and analytics",
    emoji: "📊",
    path: "/stats",
    color: "from-amber-400 to-yellow-500",
    stats: { value: 35, suffix: " seasons" },
  },
];
